...
set_include_path(get_include_path() . PATH_SEPARATOR . 'Services/validarAcceso.php');
    ...
    if (isset($_GET["Pages"])) {
        $pages = array("facturas", "inventario", "marcas", "joyas", "clientes", "Proveedores", "empleados", "usuarios", "usuariosagregar", "facturacompra", "usuarioss/nuevo", "maquillajes", "Reparaciones", "Roles", "FacturaVenta", "Controldestock","dashboard","ventasmayorista","ventasmetodo","reportecaja","facturaApartado","transferencias");
