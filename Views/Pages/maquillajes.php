<div class="card">
            ...
            <form id="quickForm" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input name="Compra" type="number" min="0" class="form-control" id="Compra" required />
                        </div>
                        <div class="error-message" id="Compra_error"></div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input name="Venta" type="number" min="0" class="form-control" id="Venta" required />
                        </div>
                        <div class="error-message" id="Venta_error"></div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input name="Mayor" type="number" min="0" class="form-control" id="Mayor" required />
                        </div>
                        <div class="error-message" id="Mayor_error"></div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-6">
                        ...
                        <input type="file" name="Maqu_Imagen" class="form-control" id="Maqu_Imagen" required />
                        <span class="text-danger"></span>
                    </div>
    ...
    <div id="Detalles">
        ...
        <div class="form-row d-flex justify-content-end">
            <div class="col-md-3">
                <a id="VolverDetalles" class="btn btn-secondary" style="color:white">Cancelar</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        ...
        async function cargarDropdowns(selectedData = {}) {
            try {
                ...
                // Limpiar y llenar dropdown de proveedores
                ...
                // Limpiar y llenar dropdown de marcas
                const MarcaDropdown = $('#Marc_Id');
                MarcaDropdown.empty();

                JSON.parse(marcas).data.forEach(marca => {
                    MarcaDropdown.append('<option value="' + marca.Marc_Id + '">' + marca.Marc_Marca + '</option>');
                });
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        ...
                        return '<img src="' + imageUrl + '" alt="Maqu_Imagen de Maquillaje" width="50">';
                    }
                },
                {
    ...
    `
        ...
        function cargarImagenActual(imagen) {
            ...
            if (imagen) {
                var imageUrl = '/PHPSistemaEsmeralda/Resources/uploads/maquillajes/' + encodeURIComponent(imagen);
                imagenActual
                    .attr('src', imageUrl)
        ...
        $('#guardarBtn').click(function() {
            if ($('#quickForm').valid()) {
                ...
                var Maqu_Imagen = $('#Maqu_Imagen')[0].files[0];

                var MaquillajeData = new FormData();
                var isInsert = Valor == "0";

                MaquillajeData.append('action', isInsert ? 'insertar' : 'actualizar');
        ...
        $('#TablaMaquillaje tbody').on('click', '.abrir-editar', function() {
            ...
            cargarImagenActual(data.Maqu_Imagen);
