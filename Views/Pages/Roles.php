...
<head>
    ...
    <style>
        ...
        #nuevoRolCollapse .btn {
            margin-top: 10px;
            /* Añade margen superior a los botones */
        }
    </style>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formNuevoRol">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-primary btn-block" style="background-color:#5d9e3e;border-color:#5d9e3e">Guardar</button>
                                </div>
                                <div class="col-md-6">
                                    <a id="CerrarModal" class="btn btn-secondary btn-block text-white">Cancelar</a>
                                </div>
                            </div>
                        </form>
                    </div>
