...
$controller = new UsuarioController($pdo); // Pasar el objeto PDO
$controllerempl = new EmpleadoController($pdo); // Pasar el objeto PDO
$controllerrol = new RolesController($pdo); // Pasar el objeto PDO
...
<body>
   ...
   $('#guardarBtn').click(function() {
    ...
    var admin = $('#Administrador').is(':checked') ? 1 : 0;
